...
def debugInfo(inputSTR, utterance):
    if DEBUG_understanding:
        print("[understanding] {} ===> {}".format(inputSTR, utterance))

def getResult(inputSTR, utterance, args, resultDICT):
    debugInfo(inputSTR, utterance)
    if utterance == "[你]懂[我]的意思嗎":
        # write your code here
        pass

    if utterance == "[你]知道[我]在說什麼嗎":
        # write your code here
        pass
    ...
    if utterance == "[我]想[我]誤解[你]的意思了":
        # write your code here
        pass

    if utterance == "[我]想是[我]搞錯了":
        # write your code here
        pass
