...
def debugInfo(inputSTR, utterance):
    if DEBUG_plan:
        print("[plan] {} ===> {}".format(inputSTR, utterance))

def getResult(inputSTR, utterance, args, resultDICT):
    debugInfo(inputSTR, utterance)
    if utterance == "[你][下週]打算要做什麼":
        # write your code here
        pass

    if utterance == "[你][下週]有安排嗎":
        # write your code here
        pass

    if utterance == "[你][今天][會]去工作嗎":
        # write your code here
        pass

    if utterance == "[你][今天]有什麼計畫":
        # write your code here
        pass

    if utterance == "[你][耶誕節]有[任何]計畫嗎":
        # write your code here
        pass
    ...
    if utterance == "[我][下週]要去看[一場]棒球賽":
        # write your code here
        pass

    if utterance == "[我]得取消[我]的[野餐計畫]因為[會]下雨":
        # write your code here
        pass
    ...
    if utterance == "因為下雨，[我]得取消[我]的[野餐計畫]":
        # write your code here
        pass
