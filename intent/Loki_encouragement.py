...
def debugInfo(inputSTR, utterance):
    if DEBUG_encouragement:
        print("[encouragement] {} ===> {}".format(inputSTR, utterance))
...
def getResult(inputSTR, utterance, args, resultDICT):
    ...
    if utterance == "讓[我]看看[你]有什麼能耐":
        # write your code here
        pass

    if utterance == "讓[我們]試試看":
        # write your code here
        pass
