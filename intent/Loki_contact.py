...
def debugInfo(inputSTR, utterance):
    if DEBUG_contact:
        print("[contact] {} ===> {}".format(inputSTR, utterance))

def getResult(inputSTR, utterance, args, resultDICT):
    debugInfo(inputSTR, utterance)
    if utterance == "[你]喜歡社交嗎":
        # write your code here
        pass

    if utterance == "[你]喜歡跟人說話嗎":
        # write your code here
        pass

    if utterance == "[你]在[臉書]的名字是":
        # write your code here
        pass

    if utterance == "[你]想跟[我]出去晃晃嗎":
        # write your code here
        pass

    if utterance == "[你]是[個][外向]的人嗎":
        # write your code here
        pass

    if utterance == "[你]有[任何]社交媒體帳戶嗎":
        # write your code here
        pass

    if utterance == "[你]有[手機號碼]嗎":
        # write your code here
        pass

    if utterance == "[你]有用[臉書]嗎":
        # write your code here
        pass

    if utterance == "[你]的[臉書]名字叫什麼":
        # write your code here
        pass

    if utterance == "[你]的[電子郵件]是":
        # write your code here
        pass

    if utterance == "[你]要跟[我]出去走走嗎":
        # write your code here
        pass

    if utterance == "[我][可以]加[你][臉書]好友嗎":
        # write your code here
        pass

    if utterance == "給[我][你]的[電子郵件]":
        # write your code here
        pass
