...
def debugInfo(inputSTR, utterance):
    if DEBUG_vehicle:
        print("[vehicle] {} ===> {}".format(inputSTR, utterance))

def getResult(inputSTR, utterance, args, resultDICT):
    debugInfo(inputSTR, utterance)
    if utterance == "[你][會]開車嗎":
    ...
    if utterance == "[你]有[一台]嗎":
        # write your code here
        pass

    if utterance == "[你]知道怎麼開車嗎":
        # write your code here
        pass

    if utterance == "[我]喜歡[瑪莎拉蒂]":
        # write your code here
        pass

    if utterance == "[我]想去比賽車":
        # write your code here
        pass

    if utterance == "[我]想去騎摩托車":
        # write your code here
        pass

    if utterance == "[我]指[藍寶堅尼]":
        # write your code here
        pass
    ...
    if utterance == "[我]有[一台][藍寶堅尼]":
        # write your code here
        pass

    if utterance == "[我]開的車是[BMW]":
        # write your code here
        pass

    if utterance == "[我們]來比[摩托車]吧":
        # write your code here
        pass

    if utterance == "那是[一台][法拉利]":
        # write your code here
        pass
