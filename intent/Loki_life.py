...
def debugInfo(inputSTR, utterance):
    if DEBUG_life:
        print("[life] {} ===> {}".format(inputSTR, utterance))

def getResult(inputSTR, utterance, args, resultDICT):
    debugInfo(inputSTR, utterance)
    if utterance == "[你][最近]過得怎麼樣":
        # write your code here
        pass

    if utterance == "[你]喜歡[你]的人生嗎":
        # write your code here
        pass

    if utterance == "[先]有雞還是[先]有蛋":
        # write your code here
        pass

    if utterance == "[我]想過[一個][快樂]的[生活]":
        # write your code here
        pass

    if utterance == "己所不欲勿施於人":
        # write your code here
        pass

    if utterance == "生命的意義是什麼":
        # write your code here
        pass
